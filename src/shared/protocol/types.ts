...
export const AUTO_LAUNCH_TIMEOUT = 12_000 // 12s — wait for app bridge ready after auto-launch
export const BRIDGE_POLL_INTERVAL = 300
export const IFRAME_MIN_HEIGHT = 200
export const IFRAME_MAX_HEIGHT = 800
export const MICRO_APP_MIN_HEIGHT = 100
export const MICRO_APP_MAX_HEIGHT = 600
export const MICRO_APP_MAX_SIZE = 200 * 1024 // 200KB
export const INACTIVE_DEMOTION_MS = 5 * 60 * 1000 // 5 minutes
